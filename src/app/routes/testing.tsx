...
import { createUserSchema, useCreateUser,useAdmins,useSupervisors } from "../../features/users/api/create-user";
...
console.log(adminOptions)
 ...
 const supervisorsOptions = [
  ...
  ...(supervisors?.supervisors?.map((supervisors) => ({
    label: supervisors.name,
    value: supervisors.id.toString(),
  })) || []),
];
